...
def encryptPage():
    ...
    if cover_file is not None:
        ...
        dpi_original_cover = cover.info.get('dpi', (72, 72))
        ...
        if message_file is not None:
            ...
            dpi_original_message = message.info.get('dpi', (72, 72))
            ...
            stego_img.save('stego.png', dpi=(dpi_original_cover, dpi_original_message))
